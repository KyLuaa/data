...
--------Criado por MaxG---------
---Base
local itemID = 5883 -- O ID do item que quando usado ira dar a quantidade de EXP desejada
local exp = 10000000 -- A quantidade de EXP desejada
local mensagem = "SouGay" -- A mensagem q ira aparecer quando for usado o item
--- Configs Principais:
